...
type CreateRequest struct {
	...
	Role            Roles                  `protobuf:"varint,5,opt,name=role,proto3,enum=user_v1.Roles" json:"role,omitempty"`
...
func (x *CreateRequest) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
type GetResponse struct {
	...
	Role      Roles                  `protobuf:"varint,4,opt,name=role,proto3,enum=user_v1.Roles" json:"role,omitempty"`
...
func (x *GetResponse) GetRole() Roles {
	if x != nil {
		return x.Role
	}
	return Roles_USER
...
var file_user_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x9a, 0x02, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x12, 0x22, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x76, 0x31, 0x2e, 0x52,
	...
	0x22, 0xe1, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	...
	0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x5f,
	0x76, 0x31, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x39,
	...
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x2a, 0x1c, 0x0a,
	0x05, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x12, 0x08, 0x0a, 0x04, 0x55, 0x53, 0x45, 0x52, 0x10, 0x00,
	...
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x72, 0x6c, 0x65, 0x78, 0x75, 0x73, 0x32, 0x31, 0x2f,
...
var file_user_proto_depIdxs = []int32{
	0,  // 0: user_v1.CreateRequest.role:type_name -> user_v1.Roles
	7,  // 1: user_v1.CreateRequest.created_at:type_name -> google.protobuf.Timestamp
	7,  // 2: user_v1.CreateRequest.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 3: user_v1.GetResponse.role:type_name -> user_v1.Roles
	7,  // 4: user_v1.GetResponse.created_at:type_name -> google.protobuf.Timestamp
	7,  // 5: user_v1.GetResponse.updated_at:type_name -> google.protobuf.Timestamp
	8,  // 6: user_v1.UpdateRequest.name:type_name -> google.protobuf.StringValue
	8,  // 7: user_v1.UpdateRequest.email:type_name -> google.protobuf.StringValue
	1,  // 8: user_v1.UserV1.Create:input_type -> user_v1.CreateRequest
	3,  // 9: user_v1.UserV1.Get:input_type -> user_v1.GetRequest
	5,  // 10: user_v1.UserV1.Update:input_type -> user_v1.UpdateRequest
	6,  // 11: user_v1.UserV1.Delete:input_type -> user_v1.DeleteRequest
